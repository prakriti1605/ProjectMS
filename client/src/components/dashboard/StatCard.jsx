...
export default function StatCard({ title, value, icon: Icon, color = "orange", subtitle }) {
  ...
  return (
    <div
      className={`group relative bg-zinc-900/90 border border-zinc-800/80 rounded-xl p-5 transition-all duration-300 ${theme.borderHover} ${theme.glow} overflow-hidden`}
    >
